...
extern const unsigned char _binary_assets_index_D42Jwy9m_css_start[];
extern const unsigned char _binary_assets_index_D42Jwy9m_css_end[];
extern const unsigned char _binary_assets_index_us_nbQ8v_js_start[];
extern const unsigned char _binary_assets_index_us_nbQ8v_js_end[];
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    {"/assets/index-D42Jwy9m.css", _binary_assets_index_D42Jwy9m_css_start, 0, "text/css"},
    {"/assets/index-us-nbQ8v.js", _binary_assets_index_us_nbQ8v_js_start, 0, "application/javascript"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[0].size = (unsigned int)(_binary_assets_index_D42Jwy9m_css_end - _binary_assets_index_D42Jwy9m_css_start);
    files[1].size = (unsigned int)(_binary_assets_index_us_nbQ8v_js_end - _binary_assets_index_us_nbQ8v_js_start);
