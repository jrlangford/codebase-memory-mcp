...
extern const unsigned char _binary_assets_index_BslCDCkP_js_start[];
extern const unsigned char _binary_assets_index_BslCDCkP_js_end[];
extern const unsigned char _binary_assets_index_D0TZVOWR_css_start[];
extern const unsigned char _binary_assets_index_D0TZVOWR_css_end[];
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    {"/assets/index-BslCDCkP.js", _binary_assets_index_BslCDCkP_js_start, 0, "application/javascript"},
    {"/assets/index-D0TZVOWR.css", _binary_assets_index_D0TZVOWR_css_start, 0, "text/css"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[0].size = (unsigned int)(_binary_assets_index_BslCDCkP_js_end - _binary_assets_index_BslCDCkP_js_start);
    files[1].size = (unsigned int)(_binary_assets_index_D0TZVOWR_css_end - _binary_assets_index_D0TZVOWR_css_start);
