...
extern const unsigned char _binary_assets_index_BC5vePsU_css_start[];
extern const unsigned char _binary_assets_index_BC5vePsU_css_end[];
extern const unsigned char _binary_assets_index_Cn0RkS_S_js_start[];
extern const unsigned char _binary_assets_index_Cn0RkS_S_js_end[];
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    {"/assets/index-BC5vePsU.css", _binary_assets_index_BC5vePsU_css_start, 0, "text/css"},
    {"/assets/index-Cn0RkS_S.js", _binary_assets_index_Cn0RkS_S_js_start, 0, "application/javascript"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[0].size = (unsigned int)(_binary_assets_index_BC5vePsU_css_end - _binary_assets_index_BC5vePsU_css_start);
    files[1].size = (unsigned int)(_binary_assets_index_Cn0RkS_S_js_end - _binary_assets_index_Cn0RkS_S_js_start);
