...
TEST(layout_empty_graph) {
    ...
    cbm_layout_result_t *r =
        cbm_layout_compute(store, "test-project", CBM_LAYOUT_OVERVIEW, NULL, 0, 100, CBM_CLUSTER_DIR, CBM_COLOR_STELLAR, false, NULL);
    ASSERT_NOT_NULL(r);
...
TEST(layout_single_node) {
    ...
    cbm_layout_result_t *r = cbm_layout_compute(store, "test", CBM_LAYOUT_OVERVIEW, NULL, 0, 100, CBM_CLUSTER_DIR, CBM_COLOR_STELLAR, false, NULL);
    ASSERT_NOT_NULL(r);
...
TEST(layout_respects_max_nodes) {
    ...
    cbm_layout_result_t *r = cbm_layout_compute(store, "test", CBM_LAYOUT_OVERVIEW, NULL, 0, 5, CBM_CLUSTER_DIR, CBM_COLOR_STELLAR, false, NULL);
    ASSERT_NOT_NULL(r);
...
TEST(layout_deterministic) {
    ...
    cbm_layout_result_t *r1 = cbm_layout_compute(store, "test", CBM_LAYOUT_OVERVIEW, NULL, 0, 100, CBM_CLUSTER_DIR, CBM_COLOR_STELLAR, false, NULL);
    cbm_layout_result_t *r2 = cbm_layout_compute(store, "test", CBM_LAYOUT_OVERVIEW, NULL, 0, 100, CBM_CLUSTER_DIR, CBM_COLOR_STELLAR, false, NULL);
    ASSERT_NOT_NULL(r1);
    ASSERT_NOT_NULL(r2);
...
TEST(layout_null_inputs) {
    ...
    cbm_layout_result_t *r = cbm_layout_compute(NULL, "test", CBM_LAYOUT_OVERVIEW, NULL, 0, 100, CBM_CLUSTER_DIR, CBM_COLOR_STELLAR, false, NULL);
    ASSERT_NULL(r);

    /* NULL project → NULL result */
    cbm_store_t *store = cbm_store_open_memory();
    r = cbm_layout_compute(store, NULL, CBM_LAYOUT_OVERVIEW, NULL, 0, 100, CBM_CLUSTER_DIR, CBM_COLOR_STELLAR, false, NULL);
    ASSERT_NULL(r);
